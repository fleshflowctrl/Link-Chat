...
- ABSOLUUT NOOIT BLUR. Gebruik NERGENS in scene/camera/backdrop/lighting/capture/outfit/pose de termen: "blur", "blurry", "blurred", "out of focus", "out-of-focus", "defocused", "bokeh", "shallow depth of field", "shallow DoF", "portrait mode", "soft focus", "motion blur", "creamy bokeh", "lens blur", "soft background", "soft blurred", "softly blurred", "hazy background", "dreamy soft", "smooth background", "creamy backdrop" of welk synoniem dan ook. Iedere foto moet eruitzien als een gewone iPhone-snapshot met ALLES scherp van voor- tot achtergrond. Schrijf "in the distance" of "distant" in plaats van "blurry-far", schrijf "small in the background" of "in the far background" in plaats van "out-of-focus", en gebruik "even exposure" of "natural daylight" in plaats van "soft focus". Achtergrond-objecten (mensen, voertuigen, gebouwen, schappen) moeten altijd herkenbaar en scherp beschreven worden, NIET als sfeerelement. Templates die toch blur-termen bevatten worden silently geweigerd.
