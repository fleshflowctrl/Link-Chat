...
const OCCUPATION_FIELDS: ReadonlyArray<OccupationOption> = [
  ...
  { text: "doktersassistente in een huisartsenpraktijk", ageMin: 20 },
  { text: "logopedist in een logopediepraktijk", ageMin: 22 },
  { text: "diëtist in een gezondheidscentrum", ageMin: 23 },
  { text: "podotherapeut met eigen praktijk", ageMin: 25 },
  { text: "ergotherapeut in een revalidatiecentrum", ageMin: 23 },
  { text: "apothekersassistent in een buurtapotheek", ageMin: 19 },
  { text: "ambulanceverpleegkundige", ageMin: 25 },
  { text: "schoonmaakster bij verschillende kantoren", ageMin: 20 },
  { text: "pakketbezorger voor PostNL", ageMin: 19, ageMax: 50 },
  { text: "buschauffeuse bij Connexxion", ageMin: 23, ageMax: 65 },
  { text: "receptioniste bij een hotel", ageMin: 19, ageMax: 50 },
  { text: "serveerster in een sterrenrestaurant", ageMin: 20, ageMax: 45 },
  { text: "kassamedewerker bij Albert Heijn", ageMin: 18, ageMax: 35 },
  { text: "winkelmedewerker bij H&M", ageMin: 18, ageMax: 35 },
  { text: "schoenenverkoopster bij een sportzaak", ageMin: 18, ageMax: 40 },
  { text: "bibliotheekmedewerker bij de openbare bieb", ageMin: 22 },
  { text: "museumsuppoost in een Amsterdams museum", ageMin: 22 },
  { text: "tatoeëerder met eigen studio aan huis", ageMin: 23 },
  { text: "interieurontwerpster voor particulieren", ageMin: 24 },
  { text: "tuinarchitect freelance", ageMin: 25 },
  { text: "schoonheidsspecialiste in een salon", ageMin: 21 },
  { text: "wenkbrauwstyliste freelance aan huis", ageMin: 21 },
  { text: "massagetherapeut in eigen praktijk", ageMin: 24 },
  { text: "personal stylist freelance", ageMin: 24 },
  { text: "blogger over reizen en lifestyle", ageMin: 22 },
  { text: "podcastmaker met eigen show", ageMin: 23 },
  { text: "voice-over actrice voor reclames", ageMin: 22 },
  { text: "vertaler Engels-Nederlands freelance", ageMin: 24 },
  { text: "accountmanager bij een softwarebedrijf", ageMin: 24, ageMax: 55 },
  { text: "callcenter-medewerker bij een telecombedrijf", ageMin: 19, ageMax: 50 },
  { text: "gemeenteambtenaar bij Burgerzaken", ageMin: 22 },
  { text: "financieel adviseur bij een hypotheekkantoor", ageMin: 24 },
  { text: "evenementenorganisator bij een bureau", ageMin: 24 },
  { text: "fundraiser voor een goed doel", ageMin: 22 },
  { text: "dierenartsassistente bij een dierenkliniek", ageMin: 20 },
  ...
  { text: "studeert verpleegkunde en loopt stage in een ziekenhuis", ageMin: 18, ageMax: 25 },
  { text: "studeert rechten en werkt parttime in de horeca", ageMin: 19, ageMax: 25 },
  { text: "doet de pabo en loopt stage op een basisschool", ageMin: 18, ageMax: 24 },
  { text: "junior accountant bij een Big-4 kantoor", ageMin: 22, ageMax: 30 },
  { text: "trainee bij een grote bank", ageMin: 22, ageMax: 28 },
  ...
  {
    text: "ballerina bij een dansgezelschap",
    bodyTypes: ["slim"],
    ageMin: 18,
    ageMax: 35,
  },
  {
    text: "actrice in opkomst, doet kleine rollen",
    bodyTypes: ["slim", "average"],
    ageMin: 22,
    ageMax: 40,
  },
  {
    text: "instagram fitness influencer met eigen merk",
    bodyTypes: ["slim", "average"],
    ageMin: 20,
    ageMax: 35,
  },
  {
    text: "surfinstructeur in de zomer, parttime in een sportzaak",
    bodyTypes: ["slim", "average"],
    ageMin: 20,
    ageMax: 45,
  },
  {
    text: "kickboks-instructrice bij een sportschool",
    bodyTypes: ["slim", "average"],
    ageMin: 22,
    ageMax: 45,
  },
  ...
  { text: "advocaat bij een mid-size kantoor, partner sinds een paar jaar", ageMin: 35 },
  { text: "huisarts in eigen praktijk", ageMin: 35 },
  { text: "tandarts met eigen praktijk", ageMin: 35 },
  { text: "psychotherapeut in eigen praktijk", ageMin: 35 },
  { text: "directrice van een basisschool", ageMin: 40 },
  { text: "afdelingshoofd in een ziekenhuis", ageMin: 38 },
  { text: "HR-manager bij een groot bedrijf", ageMin: 35 },
  { text: "eigenaresse van een kleine boekhandel", ageMin: 40 },
  { text: "B&B-eigenaresse in Limburg", ageMin: 40 },
  { text: "financial controller bij een MKB-bedrijf", ageMin: 35 },
  { text: "gepensioneerd lerares, geeft bijles aan huis", ageMin: 60 },
  { text: "activiteitenbegeleidster in een buurthuis", ageMin: 50 },
  { text: "vrijwilligster in een verzorgingstehuis", ageMin: 55 },
  { text: "sales-manager bij een MKB-bedrijf", ageMin: 35 },
  { text: "notarisassistente, al meer dan 20 jaar", ageMin: 40 },
  { text: "zelfstandig naaister voor maatkleding", ageMin: 40 },
];
